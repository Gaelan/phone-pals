{
  ...
  phonelib = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1rg82hszm9bjdb0qyxvk1glp3a88balzlhrb4vkagzqr8ryxqviy";
      type = "gem";
    };
    version = "0.6.43";
  };
  ...
  twilio-ruby = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1wam0ddbc6i0rgs0v0fn3w6yg7bpqsbvb9cnfxx8rr7ybkb11jrj";
      type = "gem";
    };
    version = "5.38.0";
  };
  ...
  web-console = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1i1jwxys0yh3li2fw91mzj9gw1p6467qndj5kxnvg798zzfg2xkk";
      type = "gem";
    };
    version = "4.0.3";
  };
